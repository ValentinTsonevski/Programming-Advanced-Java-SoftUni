...
public class TheHeiganDance {
    ...
    public static void playerIsDead(double heiganHealth, String spell, int playerRow, int playerCol) {
        String heigan = "";
        if (heiganHealth <= 0) {
    ...
    public static void heidanIsDead(double heiganHealth, int playerHealth, int playerRow, int playerCol) {
        System.out.println("Heigan: Defeated!");
        System.out.println("Player: " + playerHealth);
        System.out.printf("Final position: %d, %d", playerRow, playerCol);
    }

    public static boolean canMoveLeft(int playerRow, int playerCol, int row, int col) {
        return isValid(playerCol - 1) && playerCol < col;
    }

    public static boolean canMoveDown(int playerRow, int playerCol, int row, int col) {
        return isValid(playerRow + 1) && playerRow > row;
    }

    public static boolean canMoveRight(int playerRow, int playerCol, int row, int col) {
        return isValid(playerCol + 1) && playerCol > col;
    }

    public static boolean canMoveUp(int playerRow, int playerCol, int row, int col) {
        return (isValid(playerRow - 1) && playerRow < row);
    }
    ...
    public static boolean playerIsInDmgArea(int playerRow, int playerCol, int row, int col) {
